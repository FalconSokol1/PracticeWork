package com.example.practice12true
...
import com.example.practice12true.R
...
class MainActivity : AppCompatActivity() {
    ...
    fun radioButtonApple_Click(view: View) {
        ...
        val radioButtonApple:RadioButton=findViewById(R.id.radioButtonApple)
        }


    fun radioButtonPear_Click(view: View) {
        val imageViewMain:ImageView=findViewById(R.id.imageViewMain)
